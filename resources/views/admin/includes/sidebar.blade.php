<nav class="navbar navbar-light navbar-vertical navbar-expand-xl">
 ...
 --}}
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav collapse" id="dashboard1">
                        ...
                        @can('hasPermission', 'can_register')
                            <li class="nav-item"><a class="nav-link active" href="{{ route('admin.registration.index') }}"">
                                    <div class="d-flex align-items-center"><span
                                            class="nav-link-text ps-1">Registration</span>
                                    </div>
                                </a><!-- more inner pages-->
                            </li>
                        @endcan
                        ...
                        @can('hasPermission', 'can_register')
                            <li class="nav-item"><a class="nav-link" href="{{ route('admin.applicant.index') }}">
                                    <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Applicant</span>
                                    </div>
                                </a><!-- more inner pages-->
                            </li>
                        @endcan
                        ...
                        @can('hasPermission', 'can_register')
                            <li class="nav-item"><a class="nav-link" href="{{ route('admin.offender.index') }}">
                                    <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Offender</span>
                                    </div>
                                </a><!-- more inner pages-->
                            </li>
                        @endcan
                        ...
                        @can('hasPermission', 'can_register')
                            <li class="nav-item"><a class="nav-link" href="{{ route('admin.transaction.index') }}">
                                    <div class="d-flex align-items-center">
                                        <span class="nav-link-text ps-1">Transaction</span>
                                    </div>
                                </a><!-- more inner pages-->
                            </li>
                        @endcan
                ...
                <li class="nav-item">
                    <!-- parent pages--><a class="nav-link dropdown-indicator" href="#dashboardd" role="button"
                        data-bs-toggle="collapse" aria-expanded="true" aria-controls="dashboard">
                        <div class="d-flex align-items-center"><span class="nav-link-icon"><svg
                                    class="svg-inline--fa fa-chart-pie fa-w-17" aria-hidden="true" focusable="false"
                                    data-prefix="fas" data-icon="chart-pie" role="img"
                    ...
                    <ul class="nav collapse" id="dashboardd">

                        @can('hasPermission', 'view_history')
                            <li class="nav-item"><a class="nav-link" href="{{ route('admin.tranpurpose.index') }}">
                                    <div class="d-flex align-items-center"><span
                                            class="nav-link-text ps-1">Tranpurpose</span>
                                    </div>
                                </a><!-- more inner pages-->
                            </li>
                        @endcan
                        ...
                        @can('hasPermission', 'view_history')
                            <li class="nav-item"><a class="nav-link active" href="{{ route('admin.tranproof.index') }}">
                                    <div class="d-flex align-items-center"><span
                                            class="nav-link-text ps-1">Tranproof</span>
                                    </div>
                                </a><!-- more inner pages-->
                            </li>
                        @endcan
                        ...
                        @can('hasPermission', 'view_history')
                            <li class="nav-item"><a class="nav-link" href="{{ route('admin.trannature.index') }}">
                                    <div class="d-flex align-items-center"><span
                        ...
                        @can('hasPermission', 'view_history')
                            <li class="nav-item"><a class="nav-link" href="{{ route('admin.notransaction.index') }}">
                                    <div class="d-flex align-items-center"><span class="nav-link-text ps-1">No Transaction
                                            Purpose</span></div>
                                </a><!-- more inner pages-->
                            </li>
                        @endcan
